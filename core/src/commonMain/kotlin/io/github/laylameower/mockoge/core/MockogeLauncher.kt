...
private val LOGGER = KotlinLogging.logger("$mockoge/loader")

public fun main() {
    LOGGER.info { "Initializing  MoCKoGE Loader..." }

    val bundles = mutableListOf<io.github.laylameower.mockoge.core.Bundle>()
    ...
    "bundles/".getToPathWithDirectories().listFiles { file -> file.extension == mockoge }?.forEach { bundle ->
